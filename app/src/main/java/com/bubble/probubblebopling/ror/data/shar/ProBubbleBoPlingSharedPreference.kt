package com.bubble.probubblebopling.ror.data.shar

import android.content.Context
import androidx.core.content.edit

class ProBubbleBoPlingSharedPreference(context: Context) {
    private val chickenPrefs = context.getSharedPreferences("probubbleboplingSharedPrefsAb", Context.MODE_PRIVATE)
    ...
    companion object {
        private const val CHICKEN_SAVED_URL = "probubbleboplingSavedUrl"
        private const val CHICKEN_EXPIRED = "probubbleboplingExpired"
        private const val CHICKEN_APPLICATION_STATE = "probubbleboplingApplicationState"
        private const val CHICKEN_NOTIFICAITON_REQUEST = "probubbleboplingNotificationRequest"
        private const val CHICKEN_NOTIFICATION_REQUEST_BEFORE = "probubbleboplingNotificationRequestedBefore"
    }
}